  ...
  <body>
          ...
          <div class="container">
            <div class="nav-wrapper">
              ...
              <ul id="nav-mobile" class="right hide-on-med-and-down">
                <li><a href="http://localhost/bulkdesign/" class="white-text">Home</a></li>
                <li><a href="Blog" class="white-text">Blog</a></li>
                <li><a href="http://localhost/bulkdesign/#contato" class="white-text">Contato</a></li>
              </ul>
      ...
      <aside>
        ...
        <nav class="mobile-menu">
          <ul>
            <li><a href="http://localhost/bulkdesign/" class="white-text mobileoption">Home</a></li>
            <li><a href="Blog" class="white-text mobileoption">Blog</a></li>
            <li><a href="http://localhost/bulkdesign/#contato" class="white-text mobileoption">Contato</a></li>
          </ul>
        </nav>
      </aside>